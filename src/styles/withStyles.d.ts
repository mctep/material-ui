...
/**
   ...
   */
export type StylesRecord<ClassKey extends string = string> = Record<ClassKey, React.CSSProperties>
export type StyleRules<ClassKey extends string = string> = StylesRecord<ClassKey> & Pick<StylesRecord, ClassKey>;
